...
* The original package name 'com.sydow.mongo-event-monitor' is invalid and this project uses 'com.sydow.mongoeventmonitor' instead.
...
* [Prometheus](https://docs.spring.io/spring-boot/docs/3.3.0-SNAPSHOT/reference/htmlsingle/index.html#actuator.metrics.export.prometheus)
...
```
$ docker run --rm -p 8080:8080 mongo-event-monitor:0.0.1-SNAPSHOT
```
